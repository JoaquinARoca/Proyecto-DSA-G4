...
public class UserDAOImpl implements IUserDAO {
    ...
    @Override
    public void addUser(String id, String nombre, String contraseña, int saldo, String perfil) {
        Session session = null;
        try {
            session = FactorySession.openSession();
            User user = new User(id, nombre, contraseña,saldo);
            session.save(user);
        } catch (Exception e) {
    ...
    @Override
    public void updateUser(String id, String nombre, String contraseña, Integer saldo, String perfil) throws SQLException {
        Session session = null;
        try {
            session = FactorySession.openSession();
